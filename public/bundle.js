...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmVhbGRpbmhvIiwiYSI6ImNrZXU2b21yNDJ1eDkyc21xc2I2NTYzcW0ifQ.NDYv27r_7zZF9D4ybnTvrg';
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(urlBase, "/users/login"),
              data: {
                email: email,
                password: password
              }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "".concat(urlBase, "/users/logout")
            });
...
var stripe = Stripe('pk_test_51HSl3gKlSIPP6P5I2pzLYmNI5pNV9WnrdULFhysiGTPioGgG0xBasZujcUSPHS7xiaZNGd1kEU7ahehnR1HLN3Xz00X4A7pGvK');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData(); // equivalent to enctype='multipart/form-data'
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 7:
              document.querySelector('.btn--save-password').textContent = 'Save Password'; // clear input values
